        ...
        <div class="card offset-lg-4">
            ...
            <div class="card-body card-block">
                ...
                <div class="form-group">
                    ...
                    <input type="text"  placeholder="Enter your Brand Name" name="brand" class="form-control"></div>
                ...
                <div class="form-group">
                    ...
                    <input type="text"  placeholder="Enter Brand Description" name="description" class="form-control">
